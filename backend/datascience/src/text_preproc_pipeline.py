...
class TextPreprocess():
    ...
    def fit(self, data) -> object:
        ...
        print(f'TextPreprocess.fit {data.name} {(time.time() - start_time):.2f} seconds')
        return _out
    ...
    def transform(self, data) -> np.array:
        ...
        print(f'TextPreprocess.transform {data.name} {(time.time() - start_time):.2f} seconds')
    ...
    def save(self, data, prefix_filename):
        ...
        print(f'TextPreprocess.save {file_name} {(time.time() - start_time):.2f} seconds')
        return file_name
